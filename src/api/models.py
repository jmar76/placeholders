...
class Localidades(db.Model):
    ...
    lucainena_de_las_torres = db.Column(db.String(120),unique=False, nullable=False)
    ...
    arcos_de_la_frontera = db.Column(db.String(120),unique=False, nullable=False)
    castellar_de_la_frontera = db.Column(db.String(120),unique=False, nullable=False)
    ...
    sanlucar_de_barrameda = db.Column(db.String(120),unique=False, nullable=False)
    vejer_de_la_frontera = db.Column(db.String(120),unique=False, nullable=False)
    ...
    baños_de_la_encima = db.Column(db.String(120),unique=False, nullable=False)
    ...
    almonaster_la_real = db.Column(db.String(120),unique=False, nullable=False)
    ...
    cazalla_de_la_sierra = db.Column(db.String(120),unique=False, nullable=False)
