...
class Localidades(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    localidad = db.Column(db.String(120), unique=False, nullable=False)
    ...
    @classmethod
    def create_localidad(cls, localidad):
    #  agua_amarga, berja, las_negras, lucainena_de_las_torres, mojacar, rodalquilar, velez_blanco,
